...
<div id="card_display">
<a href="index.php?page=card_display_front&card_id=<?php echo($iCardID); ?>"><img src="<?php echo($aCards[$iCount]['path']); ?>cards/jpeg/<?php echo ($aCards[$iCount]['image']); ?>_back.jpg" border="0" width="95%"></a>
</div>
