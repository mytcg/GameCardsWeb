     ...
     <script type="text/javascript">
      ...
      <div class="divPageLogin">
        ...
        <div class="divSigninBox" style="top:202px;left:385px;">
          ...
          <span>Gender</span><br />
          <div style="margin-top: 5px;"><input type="radio" name="gender" style="margin-top:5px;width:0px;" value="Male" /> Male &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gender" style="width:0px;" value="Female" /> Female</div>
        </div>
        <div class="divSigninText">
          <span>Welcome to SA rugby cards</span>. If you are an existing MyTCG user, you can link this application to your existing account.
          <br>Otherwise just enter an username and password above, and we will create you a brand new shiny account.
          </div>
