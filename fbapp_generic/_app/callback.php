...
if ($func == 'payments_status_update') {
  ...
  $data['content']['order_id'] = $order_id;
    ...
    if ($item_id == "350") {
     ...
     $item['image_url']='https://mytcg.net/fbapp/_site/credits_1.png';
     $item['product_url']='https://mytcg.net/fbapp/_site/credits_1.png';
    }
	...
	$item['item_id'] = 700;	
     ...
     $item['image_url']='https://mytcg.net/fbapp/_site/credits_2.png';
     $item['product_url']='https://mytcg.net/fbapp/_site/credits_2.png';
    }

	if ($item_id == "1050") {
	$item['item_id'] = 1050;	
     $item['title'] = '1050 Credits';
     $item['price'] = 40;
     $item['description']='1050 TCG Credits';
     $item['image_url']='https://mytcg.net/fbapp/_site/credits_3.png';
     $item['product_url']='https://mytcg.net/fbapp/_site/credits_3.png';
    }
