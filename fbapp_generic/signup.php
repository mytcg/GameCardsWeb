    ...
    <script type="text/javascript" src="http://connect.facebook.net/en_US/all.js"></script>
     ...
     <div class="awesomeHeader"></div>
      <div class="divPageLogin">
        ...
        <div class="divSigninBox" style="top:129px;left:60px;">
        ...
        <div class="divSigninText">
          <span>Welcome to Mytcg Collectable Cards</span>.
        ...
        <div id="enter" class="divSigninEnter" style="top:371px;left:162px;"></div>
