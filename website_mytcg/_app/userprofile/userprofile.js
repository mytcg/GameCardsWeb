function COMPONENT_UserProfile(){
  ...
  if (typeof COMPONENT_UserProfile._iInited=="undefined"){
    ...
    COMPONENT_UserProfile.prototype.init=function(xml){
      ...
      if(! divData){
        ZA.createWindowPopup(20,"profile",600,500,1,0);
      ...
      $(divSeparater).css({top:6,left:291,width:2,height:"97%",backgroundColor:"#AAA"});
      ...
      $(divResponse).css({width:300,height:15,bottom:20,left:147,color:"#CC0000",textAlign:"right"});
      $(divResponse).html(response);
      
      var divSave = ZA.createDiv(divData,"cmdButton","","div");
      $(divSave).html('Save All');
      $(divSave).css({bottom:20,left:454});
      $(divSave).click(function(){
        var sendData = {
            ...
            emailaddress:$("#zupEmailAddress").attr('value'),
          };
      ...
      $(divClose).html('Close');
      $(divClose).css({bottom:20,left:524});
    ...
    COMPONENT_UserProfile.prototype.drawLeft=function(divLeft){
      ...
      $(divLeft).append("<br><br><b>Verify your email address</b><br>Click the send email button. Check your mail. Get Verification code. Enter the code below, hit enter.<br>");
      var divVerify = ZA.createDiv(divLeft,"cmdButton","","div");
      $(divVerify).html('Send Email');
      $(divVerify).css({top:292,left:15,padding:"3px 10px"});
      ...
      $(btnVerify).css({top:292,left:100,padding:"3px 10px"});
      ...
      $(chkVerify).css({top:264,left:262});
    };
    ...
    COMPONENT_UserProfile.prototype.drawRight=function(divRight){
      ...
      $(chkOwnCar).css({top:158,left:262});
      ...
      $(chkAspirationalCar).css({top:198,left:262});
      ...
      $(chkGender).css({top:239,left:262});
      ...
      $(chkLocation).css({top:280,left:262});
      
      $(divRight).append("<br><br><b>Cell Number</b><br>");
      var inpCell = ZA.createDiv(divRight,"profileInput","zupCellNumber","input");
      var chkCell = ZA.createDiv(divRight,"chkRed","chkCellNumber","div");
      $(chkCell).css({top:320,left:262});
      
      $(divRight).append("<br><br><b>Email Address</b><br>");
      var inpEmail = ZA.createDiv(divRight,"profileInput","zupEmailAddress","input");
      var chkEmail = ZA.createDiv(divRight,"chkRed","chkEmailAddress","div");
      $(chkEmail).css({top:362,left:262});
    };
  }
};
