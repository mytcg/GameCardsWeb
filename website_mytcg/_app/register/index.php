...
if (intval($_GET["register"])==1)
{
  ...
  if ($aUserExists){
    ...
    $aUserInsert=myqu(
      "INSERT INTO mytcg_user (username, email_address,category_id, is_active, date_register, credits, xp, completion_process_stage) "
      ."VALUES ('".$sUsername."', '".$sEmail."','".$iCat."',1,'".$sDate."',300,0,2)"
    );
    $aUserID=myqu(
      "SELECT user_id FROM "
      .$pre."_user "
  ...
  myqu("INSERT INTO mytcg_user_answer (detail_id,answer,answered,user_id) VALUES (1, NULL,0,".$iUserID.")");
  myqu("INSERT INTO mytcg_user_answer (detail_id,answer,answered,user_id) VALUES (2, NULL,0,".$iUserID.")");
  myqu("INSERT INTO mytcg_user_answer (detail_id,answer,answered,user_id) VALUES (3, NULL,0,".$iUserID.")");
  myqu("INSERT INTO mytcg_user_answer (detail_id,answer,answered,user_id) VALUES (4, NULL,0,".$iUserID.")");
  myqu("INSERT INTO mytcg_user_answer (detail_id,answer,answered,user_id) VALUES (5, NULL,0,".$iUserID.")");
  myqu("INSERT INTO mytcg_user_answer (detail_id,answer,answered,user_id) VALUES (6, NULL,0,".$iUserID.")");
  myqu("INSERT INTO mytcg_user_answer (detail_id,answer,answered,user_id) VALUES (7, NULL,0,".$iUserID.")");
  myqu("INSERT INTO mytcg_user_answer (detail_id,answer,answered,user_id) VALUES (8, '".$sEmail."',1,".$iUserID.")");
